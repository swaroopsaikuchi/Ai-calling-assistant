...
print(store_email_data_on_chain("1234UID", "Hello, this is a test email.", "sender@example.com", "Initial contact with details.", 75, "This email seems suspicious due to XYZ reasons."))
